...
const PROPERTY_OPTIONS = [
  { value: 'private' as const, label: 'בית פרטי', image: '/images/calculator/house.png' },
  { value: 'business' as const, label: 'נכס עסקי', image: '/images/calculator/shop.png' },
];
        ...
        >
          {PROPERTY_OPTIONS.map(({ value, label, image }) => {
            ...
            return (
              ...
              >
                <Image src={image} alt="" width={80} height={80} priority />
              </Box>
            );
          })}
        </Box>
